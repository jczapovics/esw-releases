    ...
    <DashboardLayout>
      <div className="animate-fadeIn">
        <div className="grid grid-cols-1 gap-6 mb-8">
          <Card className="p-6 shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-tr hover:from-[#e6e9f0] hover:to-[#eef1f5]" ref={qualityCardRef}>
          ...
          <Card className="p-6 shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-tr hover:from-[#accbee] hover:to-[#e7f0fd]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <Card className="p-6 shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-r hover:from-[#fdfcfb] hover:to-[#e2d1c3]">
            <div className="flex justify-between items-center mb-6">
          ...
          <Card className="p-6 shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-tr hover:from-[#d7d2cc] hover:to-[#304352]">
            <div className="flex justify-between items-center mb-6">
        ...
        <Card className="p-6 w-full shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-r hover:from-[#ee9ca7] hover:to-[#ffdde1]">
