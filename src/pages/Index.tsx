    ...
    <DashboardLayout>
      <div className="animate-fadeIn">
        <div className="grid grid-cols-1 gap-6 mb-8">
          <Card className="p-6 shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-white" ref={qualityCardRef}>
          ...
          <Card className="p-6 shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-white">
        ...
        <Card className="p-6 w-full shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-white">
